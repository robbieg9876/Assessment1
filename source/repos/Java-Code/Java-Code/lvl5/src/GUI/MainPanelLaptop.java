...
public class MainPanelLaptop extends JPanel {
	//Creates list
	...
	JCheckBox checkBox= new JCheckBox("Reverse");
	  ...
	  public GUI.currencyPanel currencyPanel;
	//creates menu
	JMenuBar setupMenu() {
	...
	private class clearListener implements ActionListener {
		public void actionPerformed(ActionEvent event) {
			...
			textField.setText("");
			resultLabel.setText("");
			currencyPanel.userInputTextField.setText("");
			currencyPanel.resultLabel.setText("");
