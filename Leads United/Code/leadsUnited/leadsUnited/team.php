...
<body>
    <div class="grid">
        ...
        <div class="wrapper">
            <div class="heading">
                <h1>Meet the Walkers</h1>
            </div>
            <content>
                <?php
                    include 'connection.php';
                    //Selects all walker profiles
                    $query="SELECT WalkerName, WalkerImg , WalkerBio, WalkerRating FROM LUProfiles ORDER BY UserID";
                    $result=mysqli_query($connection, $query);
                    //Loops through to create profile cards with data in
