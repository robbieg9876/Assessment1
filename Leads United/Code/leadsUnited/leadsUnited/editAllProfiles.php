        ...
        <div class="grid">
            ...
            ?>
                <div class="container">
                    <section id="content">
                        <h3>Edit Profile:</h3>
                        <form method="POST" action="editAllProfiles.php" autocomplete="off">
                            <p>
                        ...
                        <?php
                            ...
                            if(isset($_POST['submit'])){
                                ...
                                if($imageErr=="" && $ageErr=="" && $bioErr==""){
                                    //Updates MYSQL
                                    $query="UPDATE LUProfiles SET WalkerImg = '$Imagename', WalkerAge = '$Age', WalkerBio = '$Bio' WHERE ProfileID ='$id' ;";
                                    mysqli_query($connection, $query);//runs query
                                    
                                    //Updates APEX
                                    /*require 'oci_connect_zeus.php';
                                    $query_str="UPDATE LUPROFILES SET WALKERIMG = '$Imagename', WALKERAGE = '$Age', WALKERBIO = '$Bio' WHERE PROFILEID ='$id'";
