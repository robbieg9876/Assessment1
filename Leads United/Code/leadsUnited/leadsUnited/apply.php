...
<body>
    <div class="grid">
        ...
        <?php
            ...
            //Gets name from database using UserID
            $id=$_SESSION['userID'];
            $name=$_SESSION['user'];
         ...
         ?>
            <div class="container">
                <section id="content">
                    ...
                    <form method="POST" action="apply.php" align="left" autocomplete="off">
                        <p>
                        ...
                        <input type="submit" value="Apply" name="apply" align="left" class="reg" />
                        <br />
                    ...
                    <?php
                        ...
                        if(isset($_POST['apply'])){
                            ...
                            if ($imageErr=="" && $ageErr=="" && $bioErr==""){
                                //Updates MYSQL
                                $query="INSERT INTO LUApplicants (UserID,WalkerName,WalkerImg,WalkerAge,WalkerBio) VALUES ('$id','$Name','$Imagename','$Age','$Bio')";
                                mysqli_query($connection,$query);
                                //Updates APEX
                                /*require 'oci_connect_zeus.php';
                                $query_str="INSERT INTO LUAPPLICANTS (APPLICANTID,USERID,WALKERNAME,WALKERIMG,WALKERAGE,WALKERBIO) VALUES (SEQ_APPLICANTS.nextval,'$id','$Name','$Imagename','$Age','$Bio')";
                                $stid = oci_parse($connection2,$query_str); 
                                                    oci_execute($stid);*/
                                $_SESSION['Apply']="Application Completed: Name: '$Name' Image Name: '$Imagename' Age:'$Age' Bio: '$Bio' ";
